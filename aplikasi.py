...
def main_app(is_admin=False):
    ...
    # Fungsi untuk tampilan edit admin
    def admin_edit():
    ...
    #bagian tombol untuk menambah pesanan
    def add():
    ...
    #bagian tombol untuk menghapus pesanan
    def remove():
    ...
    s.configure('OrderFrame.TFrame', background="#F58709")
    s.configure('DishFrame.TFrame', background="#F58709", relief="raised")
    s.configure('SelectedDish.TFrame', background="#F58709", relief="sunken")
